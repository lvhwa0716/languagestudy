...
ifeq ($(TARGET_ARCH_ABI),x86_64_ERROR)
	    LOCAL_CFLAGS += -DOPT_MULTI -DOPT_X86_64 -DOPT_GENERIC -DOPT_GENERIC_DITHER -DREAL_IS_FLOAT
	    LOCAL_SRC_FILES += src/synth_x86_64.S \
